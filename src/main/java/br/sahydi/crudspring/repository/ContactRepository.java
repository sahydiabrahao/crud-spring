...
public interface ContactRepository extends JpaRepository<ContactModel, Long>{
    ...
    List<ContactModel> contactFindAll(Long contact_user_id);
    ...
    ContactModel contactFindId(Long contact_user_id, Long contact_id);
    ...
    List<ContactModel> contactFindName(Long contact_user_id, String contact_name);
